...
function stream_object(name) {
    return $('<iframe id="embed_' + name + '" src="https://player.twitch.tv/?muted=true&channel=' + name + '&parent=multitwitch.tv&parent=www.multitwitch.tv" class="stream" allowfullscreen="true"></iframe>');
}
